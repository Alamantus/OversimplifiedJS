...
function addSignatureReturns(f) {
    ...
    f.signature = '<span class="signature">' + (f.signature || '') + '</span>' +
        '<span class="type-signature small">' + returnTypesString + '</span>';
}

function addSignatureTypes(f) {
    var types = f.type ? buildItemTypeStrings(f) : [];

    f.signature = (f.signature || '') + '<span class="type-signature small">' +
...
function addAttribs(f) {
    ...
    f.attribs = util.format('<span class="type-signature small">%s</span>', attribsString);
}
